Module usableselect
    ...
    Public Sub filltotal_employee()
        ...
        da.SelectCommand = cmd
        da.Fill(ds, "EMPNO")
        employee.TotalEmployeeLabel.Text = ds.Tables("EMPNO").Rows(0).Item(0)
    End Sub
    Public Sub Filltotal_activeemployee()
        ...
        da.SelectCommand = cmd
        da.Fill(ds, "EMPNO")
        employee.ActiveLabel.Text = ds.Tables("EMPNO").Rows(0).Item(0)
    End Sub
    Public Sub Filltotal_inactiveemployee()
        ...
        da.SelectCommand = cmd
        da.Fill(ds, "EMPNO")
        employee.InactiveLabel.Text = ds.Tables("EMPNO").Rows(0).Item(0)
    End Sub
    ...
    '   da.SelectCommand = cmd
    '  da.Fill(ds, "EMPNO")
    ' employee.OnDutyLabel.Text = ds.Tables("EMPNO").Rows(0).Item(0)
    'End Sub
